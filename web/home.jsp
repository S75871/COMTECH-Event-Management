...
<body>
    ...
    <div class="grid-container">
        ...
        <% if ("ADVISOR".equals(role)) { %>
            ...
            <div class="card"><h3>Monthly Reports</h3><p>View analytics.</p><a href="#" class="btn btn-blue">View Reports</a></div>
        <% } else if ("COMMITTEE".equals(role)) { %>
            ...
            <div class="card"><h3>Send Notifications</h3><p>Broadcast reminders.</p><a href="#" class="btn btn-blue">Broadcast Message</a></div>
            <div class="card"><h3>Review Feedback</h3><p>Moderate comments.</p><a href="#" class="btn btn-blue">Moderate Feedback</a></div>
        <% } else if ("MEMBER".equals(role)) { %>
            <div class="card">
                <h3>Upcoming Events</h3>
                <p>Browse events.</p>
                <a href="EventServlet?action=browse" class="btn btn-green">Browse & RSVP</a>
            </div>
            <div class="card">
                <h3>My Reservations</h3>
                <p>Check schedules.</p>
                <a href="EventServlet?action=myReservations" class="btn btn-blue">View Schedule</a>
            </div>
            <div class="card">
                <h3>Submit Feedback</h3>
                <p>Leave comments.</p>
                <a href="#" class="btn btn-blue">Give Feedback</a>
            </div>
        <% } %>
    </div>
